...
### 📝 Introdução (Início)
- [x] **Módulo 0:** Apresentação da Jornada de Aprendizagem para o curso Desenvolvedor Full Stack Java.

### 🎨 Front-End
- [x] **Módulo 1:** Introdução ao desenvolvimento Front-end.
- [x] **Módulo 2:** Versionamento de código usando o Git (Branches, Merges e Conventional Commits).
- [x] **Módulo 3:** HTML - Estrutura Semântica e Acessibilidade. 
- [x] **Módulo 4:** CSS - Estilização e Design Responsivo. 
